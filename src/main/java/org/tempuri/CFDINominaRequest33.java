 ...
 *         &lt;element name="CFDISRelacionados" type="{http://tempuri.org/}CFDISRelacionados" minOccurs="0"/&gt;
...
public class CFDINominaRequest33 {
    ...
    @XmlElement(name = "CFDISRelacionados")
    protected CFDISRelacionados cfdisRelacionados;
    ...
    /**
     * Obtiene el valor de la propiedad cfdisRelacionados.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public CFDISRelacionados getCFDISRelacionados() {
        return cfdisRelacionados;
    }

    /**
     * Define el valor de la propiedad cfdisRelacionados.
     * 
     * @param value
     *     allowed object is
     *     {@link CFDISRelacionados }
     *     
     */
    public void setCFDISRelacionados(CFDISRelacionados value) {
        this.cfdisRelacionados = value;
    }
