 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Concepto" type="{http://www.sat.gob.mx/valesdedespensa}ConceptoMonedero" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ConceptosMonedero {
    ...
    protected List<ConceptoMonedero> concepto;
     ...
     * 
     */
    public List<ConceptoMonedero> getConcepto() {
        if (concepto == null) {
            concepto = new ArrayList<ConceptoMonedero>();
        }
