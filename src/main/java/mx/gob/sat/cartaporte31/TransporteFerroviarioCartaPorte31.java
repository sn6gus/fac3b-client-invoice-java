...
/**
 * <p>Clase Java para TransporteFerroviarioCartaPorte31 complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="TransporteFerroviarioCartaPorte31"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="DerechosDePaso" type="{http://www.sat.gob.mx/CartaPorte31}DerechosDePasoCartaPorte31" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Carro" type="{http://www.sat.gob.mx/CartaPorte31}CarroCartaPorte31" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "TransporteFerroviarioCartaPorte31", propOrder = {
    "derechosDePaso",
    "carro"
})
public class TransporteFerroviarioCartaPorte31 {
    ...
    protected List<DerechosDePasoCartaPorte31> derechosDePaso;
    @XmlElement(name = "Carro")
    protected List<CarroCartaPorte31> carro;
     ...
     * {@link DerechosDePasoCartaPorte31 }
     * 
     * 
     */
    public List<DerechosDePasoCartaPorte31> getDerechosDePaso() {
        if (derechosDePaso == null) {
            derechosDePaso = new ArrayList<DerechosDePasoCartaPorte31>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CarroCartaPorte31 }
     * 
     * 
     */
    public List<CarroCartaPorte31> getCarro() {
        if (carro == null) {
            carro = new ArrayList<CarroCartaPorte31>();
        }
        return this.carro;
    }
